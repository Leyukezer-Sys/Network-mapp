/****************************************************************************
** Meta object code from reading C++ file 'scanner_thread.h'
**
...
#error "The header file 'scanner_thread.h' doesn't include <QObject>."
...
template <> constexpr inline auto ScannerThread::qt_create_metaobjectdata<qt_meta_tag_ZN13ScannerThreadE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'portScanned'
        QtMocHelpers::SignalData<void(const PortInfo &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void ScannerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->portScanned((*reinterpret_cast< std::add_pointer_t<PortInfo>>(_a[1]))); break;
        case 1: _t->progressUpdate((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->scanFinished(); break;
        case 3: _t->resultReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ScannerThread::*)(const PortInfo & )>(_a, &ScannerThread::portScanned, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ScannerThread::*)(int )>(_a, &ScannerThread::progressUpdate, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ScannerThread::*)()>(_a, &ScannerThread::scanFinished, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (ScannerThread::*)(const QString & )>(_a, &ScannerThread::resultReady, 3))
            return;
    }
}
...
// SIGNAL 0
void ScannerThread::portScanned(const PortInfo & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ScannerThread::progressUpdate(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void ScannerThread::scanFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void ScannerThread::resultReady(const QString & _t1)
{
